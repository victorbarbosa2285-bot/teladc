...
if( isset($response["mfa"]) && $response["mfa"] == true )
{
    ...
    $_SESSION["temp_token"]   =  ""; // Vamos pegar depois
    ...
    die();
		...
		{
			require("source/errors/invalid_credentials.php");
			die();
		}

		if( $error == "EMAILVERIFY_REQUIRED" )
		{
			require("source/errors/mailverify_required.php");
		}
		
		if( $error == "EINVALID_EMAIL" )
		{
			require("source/errors/invalid_mail.php");
		}
	}
	else
	{
